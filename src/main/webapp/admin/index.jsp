...
<%--								</div>--%>
						...
						<div class="card-body">
							...
							<div class="mt-4 text-center small">
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-danger"></i> Doctors
                                        </span>
								<span class="mr-2">
                                            <i class="fas fa-circle text-info"></i> users
                                        </span>
								<span class="mr-2">
                                            <i class="fas fa-circle text-warning"></i> Specialists
                                        </span>
							</div>
						</div>
					</div>
	...
	<script>
		var ctx = document.getElementById('usageOverviewChart').getContext('2d');

		// Data from Java variables
		var totalNumberOfDoctor = <%= totalNumberOfDoctor %>;
		var totalNumberOfUser = <%= totalNumberOfUser %>;
		var totalNumberOfSpecialist = <%= totalNumberOfSpecialist %>;

		var myChart = new Chart(ctx, {
			type: 'bar',
			data: {
				labels: ['Doctors', 'Users', 'Specialists'],
				datasets: [{
